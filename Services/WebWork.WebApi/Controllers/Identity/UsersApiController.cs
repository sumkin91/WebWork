...
using WebWork.Domain.DTO.Identity;
using WebWork.Domain.Entities.Identity;
using WebWork.Intefaces;

namespace WebWork.WebApi.Controllers.Identity;
...
{
    private readonly UserStore<User, Role, WebWorkDB> _UserStore;
    private readonly ILogger<UsersApiController> _Logger;

    public UsersApiController(WebWorkDB db, ILogger<UsersApiController> Logger)
    {
        _Logger = Logger;
        _UserStore = new(db);
    }
